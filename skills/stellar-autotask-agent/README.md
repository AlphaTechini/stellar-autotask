...
I use this folder for the publishable skill that teaches an OpenClaw-style agent how to bootstrap a wallet when needed, issue a wallet-backed agent credential, and operate the MCP tools for the Stellar Autotask workflow.
