...
To find shared native XLM payment submission visit [sendNativePayment.ts](file:///C:/Hackathons/Stellar%201/stellar-autotask/McpServer/src/sendNativePayment.ts).
...
To find agent wallet top-up logic visit [fundWalletOnStellar.ts](file:///C:/Hackathons/Stellar%201/stellar-autotask/McpServer/src/fundWalletOnStellar.ts).
...
The Stellar funding helper can be found in [sendNativePayment.ts](file:///C:/Hackathons/Stellar%201/stellar-autotask/McpServer/src/sendNativePayment.ts).
